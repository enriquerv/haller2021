<?php  
	...
	include('../widgets/header_sobrecargo.php');
?>

<section class="img-section2" style="margin-top: 172px" id="ini_sobrecargo">
	<img src="<?php echo $direction; ?>/assets/images/lic/titulo_sobrecargo.png" width="100%">
</section>
...
<section>
	...
	<div class="row">
		...
		<div class="col-12 text-center">
			<img src="<?php echo $direction; ?>/assets/images/new/logo_afac.png" width="300px">
			<p class="afac">CURSO RECONOCIDO POR LA AFAC</p>
			<p class="afac">AGENCIA FEDERAL DE AVIACIÓN CIVIL</p>
			<p class="afac">PERMISO: F-170</p>
		</div>
		<div class="col-12">
			<img src="<?php echo $direction; ?>/assets/images/new/sob_06.png" width="100%">
		</div>
	</div>
      ...
      <div class="modal-body">
        <div id="carouselIndicators" class="carousel slide" data-ride="carousel">
           <div class="carousel-inner">
              <div class="carousel-item active"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/1.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/2.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/3.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/4.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/5.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/6.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/7.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/8.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/9.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/10.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/11.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/12.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/13.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/14.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/15.jpg" alt="First slide"></div>
              <div class="carousel-item"><img class="d-block img-gallery" src="<?php echo $direction; ?>/sobrecargo/images/16.jpg" alt="First slide"></div>
           </div>
...
<script>
	...
	$( document ).ready(function() {
	    $("#navGallery").click(function(event) {
	    	$("#galleryCenter").modal('toggle');
	    });
	});
</script>